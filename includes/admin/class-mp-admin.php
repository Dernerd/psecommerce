...
class MP_Admin {
	...
	protected function _init_dash_notices() {
		...
		if ( file_exists( dirname( __FILE__ ) . '/includes/admin/dash-notice/psource-dash-board.php' ) ) {
			...
			$psource_notices[] = array(
				...
				'screens'	 => array(
					...
					'edit-product_tag',
					'settings_page_psecommerce-ms-network'
				)
			);

			include_once mp_plugin_dir( 'includes/admin/dash-notice/psource-dash-notification.php' );
		}
	}
	...
	public function add_help_tab() {
		get_current_screen()->add_help_tab( array(
			'id'		 => 'psecommerce-help',
			'title'		 => __( 'PSeCommerce Hilfezentrum', 'mp' ),
			'content'	 => '<iframe src="n3rds.work/piestingtal-source-project-psp-die-wordpress-opensource-community-piestingtal/psecommerceps-die-kostenlose-oesterreichische-ecommerce-loesung-fuer-wordpress/" width="100%" height="600px"></iframe>'
		) );
	}
