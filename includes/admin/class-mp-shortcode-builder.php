...
class MP_Shortcode_Builder {
	...
	public function display_mp_list_categories_attributes() {
		...
		<table id="mp-list-categories-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Wenn ein Wert eingegeben wird, wird ein Link zu allen Kategorien angezeigt, wenn der Stil auf Liste gesetzt ist.', 'mp' ); ?></span></span> show_option_all</th>
				<td>
					<input type="text" name="show_option_all" data-default="" value="" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Sortiere Kategorien alphabetisch, nach eindeutiger Kategorie-ID oder nach der Anzahl der Beiträge in dieser Kategorie.', 'mp' ); ?></span></span> orderby</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Sortierreihenfolge für Kategorien (entweder aufsteigend oder absteigend).', 'mp' ); ?></span></span> order</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Schaltet die Anzeige der aktuellen Anzahl von Posts in jeder Kategorie um.', 'mp' ); ?></span></span> show_count</th>
				<td>
					<input type="checkbox" name="show_count" data-default="" value="1" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Schaltet die Anzeige von Kategorien ohne Beiträge um.', 'mp' ); ?></span></span> hide_empty</th>
				<td>
					<input type="checkbox" name="hide_empty" data-default="1" value="1" checked />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Legt fest, ob die Beschreibung einer Kategorie in das title-Attribut der erstellten Links eingefügt wird (z.B. &lt;a title="&lt;em&gt;Category Description&lt;/em&gt;" href="...).', 'mp' ); ?></span></span> use_desc_for_title</th>
				<td>
					<input type="checkbox" name="use_desc_for_title" data-default="1" value="1" checked />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Zeige nur Kategorien an, die untergeordnete Elemente der durch diesen Parameter angegebenen Kategorie sind.', 'mp' ); ?></span></span>  child_of</th>
				<td>
					<?php
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Schließe nur diese Kategorien ein.', 'mp' ); ?></span></span> include</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Kategoriebaum von den Ergebnissen ausschließen. Der Parameter include muss leer sein. Wenn der hierarchische Parameter true ist, verwende exclude anstelle von exclude_tree.', 'mp' ); ?></span></span> exclude_tree</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Zeige Unterkategorien als innere Listenelemente (unter dem übergeordneten Listenelement) oder inline an.', 'mp' ); ?></span></span> hierarchical</th>
				<td>
					<input type="checkbox" name="hierarchical" data-default="1" value="1" checked />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Lege den Titel und den Stil des äußeren Listenelements fest. Wenn vorhanden, aber leer, wird das äußere Listenelement nicht angezeigt.', 'mp' ); ?></span></span> title_li</th>
				<td>
					<input type="text" name="title_li" data-default="Categories" value="Categories" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Stelle den Text so ein, dass angezeigt wird, wenn keine Kategorien aufgelistet sind.', 'mp' ); ?></span></span> show_option_none</th>
				<td>
					<input type="text" name="show_option_none" data-default="Keine Kategorien" value="Keine Kategorien" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Legt die Anzahl der anzuzeigenden Kategorien fest. Dadurch wird der SQL LIMIT-Wert definiert.', 'mp' ); ?></span></span> number</th>
				<td>
					<input type="text" name="number" data-default="" value="" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Dieser Parameter steuert, wie viele Ebenen in der Hierarchie der Kategorien in die Liste der Kategorien aufgenommen werden sollen. HINWEIS: Das standardmäßig deaktivierte "hierarchische" Argument überschreibt das Tiefenargument, sofern es nicht wahr ist. Wenn das Argument falsch ist, werden alle Kategorien angezeigt. Wenn es aktiviert ist, wird der Wert im Argument "Tiefe" verwendet.', 'mp' ); ?></span></span> depth</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Berechnet die Anzahl der Links oder Posts, indem Elemente aus untergeordneten Kategorien einbezogen werden. Wenn show_counts und hierarchical true sind, wird dies automatisch auf true gesetzt.', 'mp' ); ?></span></span> pad_counts</th>
				<td>
	...
	public function display_mp_dropdown_categories_attributes() {
		...
		<table id="mp-dropdown-categories-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die maximale Tiefe. Dies wird ignoriert, es sei denn, hierarchisch ist auf true gesetzt.', 'mp' ); ?></span></span> depth</th>
				<td>
					<input type="text" name="depth" data-default="0" value="0" />
				</td>
			</tr>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Welche Kategorie-ID ist ausgewählt.', 'mp' ); ?></span></span> selected</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Der Attributwert "tabindex" für das ausgewählte Element. ', 'mp' ); ?></span></span> tab_index</th>
				<td>
	...
	public function display_mp_tag_cloud_attributes() {
		...
		<table id="mp-tag-cloud-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die Textgröße des Tags mit dem kleinsten Zählwert (Einheiten, angegeben durch den Einheitenparameter).', 'mp' ); ?></span></span> smallest</th>
				<td>
					<input type="text" name="smallest" data-default="8" value="8" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die Textgröße des Tags mit dem größten Zählwert (Einheiten, angegeben durch den Einheitenparameter).', 'mp' ); ?></span></span> largest</th>
				<td>
					<input type="text" name="largest" data-default="22" value="22" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Maßeinheit für die kleinsten und größten Werte. Dies kann ein beliebiger CSS-Längenwert sein, z.B. pt, px, em, %.', 'mp' ); ?></span></span> unit</th>
				<td>
					<input type="text" name="unit" data-default="pt" value="pt" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die Anzahl der tatsächlichen Tags, die in der Cloud angezeigt werden sollen. (Verwenden Sie "0", um alle Tags anzuzeigen.)', 'mp' ); ?></span></span> number</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Der Text/Leerzeichen zwischen Tags', 'mp' ); ?></span></span> separator</th>
				<td>
					<input type="text" name="separator" data-default="\n" value="\n" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Reihenfolge der Tags.', 'mp' ); ?></span></span> orderby</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Durch Kommas getrennte Liste der auszuschließenden Tags (term_id). Beispiel: exclude = 5,27 bedeutet, dass Tags mit der term_id 5 oder 27 NICHT angezeigt werden. Standardmäßig wird nichts ausgeschlossen.', 'mp' ); ?></span></span> exclude</th>
				<td>
					<input type="text" name="exclude" data-default="" value="" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Durch Kommas getrennte Liste der einzuschließenden Tags (term_id). Include = 5,27 bedeutet beispielsweise, dass nur Tags mit der term_id 5 oder 27 angezeigt werden. Standardmäßig wird alles eingeschlossen.', 'mp' ); ?></span></span> include</th>
				<td>
	...
	public function display_mp_featured_products_attributes() {
		...
		<table id="mp-featured-products-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob die Produktliste paginiert werden soll. Dies ist nützlich, um nur eine Teilmenge anzuzeigen.', 'mp' ); ?></span></span> paginate</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die Seitenzahl, die in der Produktliste angezeigt werden soll, wenn "paginieren" auf "wahr" gesetzt ist.', 'mp' ); ?></span></span> page</th>
				<td>
					<input type="text" name="page" data-default="1" value="1" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Wie viele Produkte sollen in der Produktliste angezeigt werden, wenn "paginieren" auf "wahr" gesetzt ist?.', 'mp' ); ?></span></span> per_page</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Welches Feld, um Produkte zu bestellen.', 'mp' ); ?></span></span> order_by</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Bestellanweisung für Produkte von.', 'mp' ); ?></span></span> order</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Beschränkt die Liste auf eine bestimmte Produktkategorie.', 'mp' ); ?></span></span> category</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Beschränkt die Liste auf ein bestimmtes Produkt-Tag.', 'mp' ); ?></span></span> tag</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob die Produktfilter angezeigt werden sollen.', 'mp' ); ?></span></span> filters</th>
				<td>
	...
	public function display_mp_popular_products_attributes() {
		...
		<table id="mp-popular-products-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die maximale Anzahl der anzuzeigenden Produkt', 'mp' ); ?></span></span> number</th>
				<td>
	...
	public function display_mp_related_products_attributes() {
		...
		<table id="mp-related-products-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Das Produkt, für das verwandte Produkte angezeigt werden sollen.', 'mp' ); ?></span></span> product_id</th>
				<td>
					<input type="text" class="mp-select-product" name="product_id" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Wie Produkte in Beziehung gesetzt werden', 'mp' ); ?></span></span> relate_by</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Wie viele verwandte Elemente sollen angezeigt werden?.', 'mp' ); ?></span></span> limit</th>
				<td>
	...
	public function display_mp_list_products_attributes() {
		...
		<table id="mp-list-products-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die Seitenzahl, die in der Produktliste angezeigt werden soll, wenn "paginieren" auf "true" gesetzt ist.', 'mp' ); ?></span></span> page</th>
				<td>
					<input type="text" name="page" data-default="1" value="1" />
				</td>
			</tr>
	...
	public function display_mp_product_attributes() {
		...
		<table id="mp-product-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die ID des anzuzeigenden Produktes.', 'mp' ); ?></span></span> product_id</th>
				<td>
					<input type="text" name="product_id" data-default="" class="mp-select-product" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob der Produkttitel angezeigt werden soll.', 'mp' ); ?></span></span> title</th>
				<td>
	...
	public function display_mp_product_image_attributes() {
		...
		<table id="mp-product-image-shortcode" class="form-table" style="display:none">
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Die ID des Produktes.', 'mp' ); ?></span></span> product_id</th>
				<td>
					<input type="text" name="product_id" data-default="" class="mp-select-product" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Welcher Kontext für voreingestellte Größenoptionen.', 'mp' ); ?></span></span> context</th>
				<td>
	...
	public function display_mp_buy_button_attributes() {
		...
		<table id="mp-buy-button-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Welcher Kontext für die Anzeige.', 'mp' ); ?></span></span> context</th>
				<td>
	...
	public function display_mp_cart_widget_attributes() {
		...
		<table id="mp-cart-widget-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Der Text wird vor dem Warenkorb angezeigt.', 'mp' ); ?></span></span> custom_text</th>
				<td>
					<input type="text" name="custom_text" data-default="" value="" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob das Produktbild ein- oder ausgeblendet werden soll.', 'mp' ); ?></span></span> show_product_image</th>
				<td>
					<input type="checkbox" name="show_product_image" data-default="1" value="1" checked />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob die Produktmenge ein- oder ausgeblendet werden soll.', 'mp' ); ?></span></span> show_product_qty</th>
				<td>
					<input type="checkbox" name="show_product_qty" data-default="1" value="1" checked />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob der Produktpreis angezeigt oder ausgeblendet werden soll.', 'mp' ); ?></span></span> show_product_price</th>
				<td>
					<input type="checkbox" name="show_product_price" value="1" />
				</td>
			</tr>
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Gibt an, ob der Warenkorb nur auf Shopseiten angezeigt werden soll oder nicht.', 'mp' ); ?></span></span> only_store_pages</th>
				<td>
	...
	public function display_mp_cart_link_attributes() {
		...
		<table id="mp-cart-link-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Der Text, der im Link angezeigt werden soll.', 'mp' ); ?></span></span> link_text</th>
				<td>
	...
	public function display_mp_list_global_products_attributes() {
		...
		<table id="mp-list-global-products-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Wie viele Produkte sollen in der Produktliste angezeigt werden, wenn "paginieren" auf "falsch" gesetzt ist?.', 'mp' ); ?></span></span> limit</th>
				<td>
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Bestellanweisung für Produkten von.', 'mp' ); ?></span></span> order</th>
				<td>
					<label><input type="radio" name="order" data-default="<?php echo esc_attr( mp_get_setting( 'order' ) ); ?>" value="ASC" <?php checked( 'ASC', mp_get_setting( 'order' ) ); ?> /> <?php _e( 'Aufsteigend', 'mp' ); ?></label> &nbsp; &nbsp;
					<label><input type="radio" name="order" data-default="<?php echo esc_attr( mp_get_setting( 'order' ) ); ?>" value="DESC" <?php checked( 'DESC', mp_get_setting( 'order' ) ); ?> /> <?php _e( 'Absteigend', 'mp' ); ?></label>
				</td>
	...
	public function display_mp_global_tag_cloud_attributes() {
		...
		<table id="mp-global-tag-cloud-shortcode" class="form-table" style="display:none">
			...
			<tr>
				<th scope="row"><span class="mp-tooltip dashicons dashicons-editor-help"><span><?php _e( 'Legt die Anzahl der anzuzeigenden Tags fest. Dadurch wird der SQL LIMIT-Wert definiert.', 'mp' ); ?></span></span> number</th>
				<td>
					<input type="text" name="limit" data-default="" value="" />
				</td>
			</tr>
