				...
				<div class="mp_content-tabs">
					<div id="mp-quick-setup-tabs" class="mp_quick_setup_tabs">
						...
						<ul class="mp_tabs_labels">
							...
							<li class="mp_tab_label"><a class="mp_tab_label_link" href="#mp-quick-setup-tab-metric-system"><span class="dashicons-before dashicons-cart mp_icon mp_icon-inline mp_icon-rounded"></span> <?php _e( 'Metrisches System', 'mp' ); ?></a></li>
								...
								<div class="mp_tab_content">
									...
									<div class="mp_tab_content_block">
										<div id="mp-content-metric-system" class="mp_tab_content_metric_system">
											<p class="mp_tab_content_label"><?php _e( 'Metrisches System', 'mp' ); ?></p>
