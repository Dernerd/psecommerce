=== PSeCommerce-Statistiken ===
Contributors: WMS N@W
Donate link: https://n3rds.work
Tags: e-commerce, statistics, psecommerce, google charts
...
Display PSeCommerce statistics using google charts.

== Description ==

This plugin displays store and sales statistics for stores using the PSeCommerce plugin. It was created for the http://magazi.org network of stores.
